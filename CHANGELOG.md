...
|---------|-------|-------|
| [hotfix/pandera-pandas-compatibility](https://github.com/network-wrangler/network_wrangler/tree/hotfix/pandera-pandas-compatibility) | 2026-01-07 | Hotfix: Fix pandera/pandas compatibility issues, Python 3.9 TypeGuard compatibility, type guard bug fixes, mkdocs build compatibility, and remove unused noqa directives. |
